          ...
          <tbody>
            ...
            {users.map((user, index) => (
              <tr key={user._id}>
                ...
                {
                    user.role==='admin'?<span className='bg-[#D1A054] text-white px-2 py-1 rounded-lg'>Admin</span>:  <button  onClick={()=>handleMakeAdmin(user)} className={`btn bg-[#D1A054] ${disabledBtn} `}>
                    <svg
