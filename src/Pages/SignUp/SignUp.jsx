      ...
      <div className="flex  w-full max-w-sm mx-auto overflow-hidden  rounded-lg shadow-lg  lg:max-w-7xl ">
        <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
          ...
          <form onSubmit={handleSignUp}>
            ...
            <div className="mt-6">
              <button
                className="w-full bg-[#D1A054] px-6 py-3 text-sm font-medium tracking-wide  capitalize transition-colors duration-300 transform  rounded-lg focus:outline-none focus:ring focus:ring-gray-300 focus:ring-opacity-50"
                type="submit"
              >
                Sign Up
              </button>
